...
/**
 * Placing a single loaded Dummy Spawner item alone in a crafting grid "resets" it: clears the max
 * health override, the display metric customization, and any name (from a name tag or an anvil
 * rename), while keeping the equipment/curios it remembers untouched.
 */
