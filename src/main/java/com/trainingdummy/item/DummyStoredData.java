...
/**
 * A dummy's customization (max health override, equipment, curios, damage display), folded into
 * its spawner item data component when broken with a Stick - see
 * entity.DummyEntity#spawnLoadedDummySpawner - and restored when that item is placed back down -
 * see item.DummySpawnItem#useOn.
 */
